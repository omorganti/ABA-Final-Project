---
title: "Final Project ABA"
output: html_document
---
#Final Project Advances Business Analytics
...
##Step 1 
###We decide to choose the dataset "Walmart" for our calculations of the differents fonctions (SMA, EWMA and ARMA)
...
##Step 2
###We initialize our 3 coefficients
...
###We create our two new functions COMB with the linear coefficients
...
###We create new variables to initialize the vector
...
###Than we can create our function to randomize alpha (al) and beta (be). 
###Moreover, gamma = 1 - alpha - beta 
...
###We create a dataframe with all the value of alpha, beta and e^2
###This dataframe will determine the minimum alpha and beta
...
###At least, we compare the differences between the potential errors to the initial function
